...
if(FCONFIG_TEST_VCPKG_INSTALL)
	set(CTEST_CONFIGURE_COMMAND "${CTEST_CONFIGURE_COMMAND} -DFCONFIG_TEST_VCPKG_INSTALL=ON")
endif()

if(FCONFIG_TEST_BUILD_SHARED)
	set(CTEST_CONFIGURE_COMMAND "${CTEST_CONFIGURE_COMMAND} -DFCONFIG_BUILD_SHARED_LIBS=ON")
endif()
