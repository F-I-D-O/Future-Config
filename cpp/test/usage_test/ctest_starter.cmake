...
if(FCONFIG_VCPKG_INSTALL)
	...
	execute_process(
		COMMAND vcpkg install yaml-cpp inja spdlog tclap future-config --triplet ${FCONFIG_VCPKG_TRIPLET} --overlay-ports=${FCONFIG_PORT_DIR} --binarysource=clear
		RESULT_VARIABLE FCONFIG_INSTALL_RESULT
	)
else()
